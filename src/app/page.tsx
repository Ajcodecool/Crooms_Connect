...
<div class="card" onclick="window.open('https://www.nytimes.com/games/wordle/index.html', '_blank')"><span class="icon"> 🏆 </span><h3>wordle</h3><p>Guess word you are daily obligated hehe.</p></div>
<div class="card" onclick="window.open('https://docs.google.com/forms/d/e/1FAIpQLScEqgYX1gD8hl9kldzTUq5hQ_-L-sp2ME1q_6HV0hPK1GaPLA/viewform?usp=header', '_blank')"><span class="icon"> 📍 </span><h3>WE Need YOU</h3><p>Are YOU a game developer? Do you wanna share your works with the world? Click here to learn more!</p></div>
</div>
</div>
</section>
</div>
...
<ul>
<li>Not official: This is a student-run educational/communication platform—not an official school/district site.</li>
...
<li>Privacy & safety: Don’t post private information. Not for emergencies—call 911 for urgent issues.</li>
<li>We may moderate: We can remove content and suspend access for violations.</li>
<li>“As is”: No warranties; you use the platform at your own risk.</li>
</ul>

<h3>1) Definitions</h3>
<p><strong>“Platform” / “Crooms Connect”</strong>: The website, app(s), pages, services, features, and content administered under the Crooms Connect name.</p>
<p><strong>“We”, “Us”, “Our”</strong>: Crooms Connect student developers/operators and authorized volunteers.</p>
<p><strong>“User(s)”</strong>: Any person who accesses or uses the Platform (students, parents/guardians, staff, guests).</p>
<p><strong>“User-Generated Content (UGC)”</strong>: Any content posted, uploaded, shared, or submitted by Users (text, images, links, files, media, comments).</p>
<p><strong>“Official Sources”</strong>: School or district-operated publications, websites, and staff communications.</p>
...
<p>We may update these Terms at any time. Changes are effective when posted with the “Last Updated” date. Continued use after changes constitutes acceptance. For significant updates, we may provide additional notice (e.g., banner, email, in-app notice).</p>
...
<h2>9) “AS IS” and “AS AVAILABLE”</h2>
<p>The Platform is provided “AS IS” and “AS AVAILABLE”, with all faults and defects, without warranties of any kind (express or implied), including but not limited to merchantability, fitness for a particular purpose, non-infringement, uninterrupted operation, error-free content, or freedom from malware.</p>
...
<p>Features labeled “beta,” “preview,” or “experimental” may be incomplete, change without notice, or be removed.</p>
...
<p>Children’s privacy: If we learn we collected children’s personal data without appropriate consent/authorization, we will delete it upon discovery.</p>
...
<li>Interfere with Platform function, overload servers, or disrupt others’ use.</li>
...
<p>You agree to defend, indemnify, and hold harmless Crooms Connect, its developers, volunteers, and affiliates from any claims, damages, liabilities, costs, and expenses (including reasonable attorneys’ fees) arising from:</p>
<ol type="a">
<li>your use of or access to the Platform;</li>
<li>your violation of these Terms or applicable laws/policies;</li>
<li>any infringement or violation of another’s rights.</li>
</ol>
...
<p>You consent to receiving electronic communications; they satisfy legal requirements for “written” communications where permitted.</p>
...
<p>If accessed via a mobile app, your use may be subject to the app store’s terms. The app store provider is not responsible for support or legal claims. You must comply with usage rules of the app store.</p>
...
<p>Disclaimer: Crooms Connect is a student-run educational platform provided “AS IS” and not an official school/district site. No warranties are made regarding accuracy or availability. Schedules and announcements may change—verify with official sources. By using this site, you agree to our Terms, including conduct rules, UGC license, moderation rights, and limitations of liability. Not for emergencies—call 911.</p>
</div>
</section>
</div>
...
if (target === "polls") {
window.location.href = "https://docs.google.com/forms/d/e/1FAIpQLSeCDwsg8kIobaXPjk2DRD61wuk0H83cWq9w3TseoENh9Gdg5Q/viewform?usp=header";
return;
}
